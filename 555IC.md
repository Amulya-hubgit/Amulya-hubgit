...
- When we used the monostable 555 timer and triggered it with those edges, it gave us a clean and steady pulse every time. This is very helpful when we want the output to stay the same no matter how long the input pulse is.
